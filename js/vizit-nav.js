      ...
      cols: [
        {
          title: 'Products',
          items: [
            { href: 'platform.html', label: 'Vizit Next Gen Platform' },
            { href: 'api.html', label: 'Vizit API' }
          ]
        }
      ],
      cards: [
        { theme: 'dark', href: 'partners.html', title: 'Partner Ecosystem', sub: 'Integrations and partners that extend Vizit.' }
      ]
    },
    {
      ...
      cols: [
        {
          title: 'Results',
          items: [
            { href: 'case-study.html', label: 'Case Studies' }
          ]
        }
      ]
    },
